package W9_Exercises.W92_IOStreams;
...
public class User {
    ...
    public static User getUserInfo() {
       User user = new User("Eve", "eve@gmail.com", "1767034455", 33);;
        return user;
    }
    ...
    public static List<User> getUsersInfo(){
        ...
        User userOne = new User("Eve", "eve@gmail.com", "1767034455", 33);;
        User userTwo = new User("Max", "max@gmail.com", "2456789", 20);;
        User userThree = new User("Olivia", "olivia@gmail.com", "2323", 1);
    ...
    public void readUserInfo() {
        User user = getUserInfo();
        try (FileInputStream fis = new FileInputStream("output.data")) {
            int c = 0;
            while ((c = fis.read()) != - 1) {
                sb.append((char) c);
            }
    ...
    public void askForUpdate() {
        ...
        if (answer.equalsIgnoreCase("yes")) {
            user.updateInfo();
            try (FileOutputStream fos = new FileOutputStream("output.data");
                 ObjectOutputStream oos = new ObjectOutputStream(fos)) {
                oos.writeObject(user);
                System.out.println("Information updated and saved.");
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public void updateInfo() {
        System.out.println("Which information would you like to update: Name / email / phone number / favorite color");
